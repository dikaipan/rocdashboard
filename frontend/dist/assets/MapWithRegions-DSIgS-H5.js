import{R as J,r as A,j as a,az as W,aA as w,aB as O}from"./vendor-react-C0jbZujj.js";import{L as j}from"./vendor-maps-C_U1R0uQ.js";import{u as F}from"./index-BT-vs0to.js";const $=`{
...
`,H=JSON.parse($),P={Jakarta:"DKI JAKARTA","Jakarta Pusat":"DKI JAKARTA","Jakarta Selatan":"DKI JAKARTA","Jakarta Barat":"DKI JAKARTA","Jakarta Timur":"DKI JAKARTA","Jakarta Utara":"DKI JAKARTA",Bandung:"JAWA BARAT",Bogor:"JAWA BARAT",Depok:"JAWA BARAT",Bekasi:"JAWA BARAT",Cirebon:"JAWA BARAT",Tasikmalaya:"JAWA BARAT",Sukabumi:"JAWA BARAT",Cikampek:"JAWA BARAT",Cianjur:"JAWA BARAT",Kuningan:"JAWA BARAT",Semarang:"JAWA TENGAH",Solo:"JAWA TENGAH",Yogyakarta:"DAERAH ISTIMEWA YOGYAKARTA",Tegal:"JAWA TENGAH",Purwokerto:"JAWA TENGAH",Pekalongan:"JAWA TENGAH",Madiun:"JAWA TENGAH",Blora:"JAWA TENGAH",Klaten:"JAWA TENGAH",Jepara:"JAWA TENGAH","Madiun (Bojonegoro)":"JAWA TENGAH",Surabaya:"JAWA TIMUR",Malang:"JAWA TIMUR",Jember:"JAWA TIMUR",Kediri:"JAWA TIMUR",Banyuwangi:"JAWA TIMUR",Probolinggo:"JAWA TIMUR",Pamekasan:"JAWA TIMUR",Bangkalan:"JAWA TIMUR",Tangerang:"BANTEN",Serang:"BANTEN",Medan:"SUMATERA UTARA","Pematang Siantar":"SUMATERA UTARA",Tarutung:"SUMATERA UTARA","Rantau Prapat":"SUMATERA UTARA",Padang:"SUMATERA BARAT",Payakumbuh:"SUMATERA BARAT",Palembang:"SUMATERA SELATAN",Lahat:"SUMATERA SELATAN",Lubuklinggau:"SUMATERA SELATAN",Pekanbaru:"RIAU",Dumai:"RIAU",Tembilahan:"RIAU",Batam:"KEPULAUAN RIAU",Bintan:"KEPULAUAN RIAU",Lampung:"LAMPUNG",Kotabumi:"LAMPUNG",Jambi:"JAMBI",Bengkulu:"BENGKULU",Aceh:"DI. ACEH",Bangka:"BANGKA BELITUNG",Belitung:"BANGKA BELITUNG",Pontianak:"KALIMANTAN BARAT",Ketapang:"KALIMANTAN BARAT",Sanggau:"KALIMANTAN BARAT",Palangkaraya:"KALIMANTAN TENGAH","Pangkalan Bun":"KALIMANTAN TENGAH",Banjarmasin:"KALIMANTAN SELATAN",Balikpapan:"KALIMANTAN TIMUR",Samarinda:"KALIMANTAN TIMUR",Berau:"KALIMANTAN TIMUR",Tarakan:"KALIMANTAN UTARA",Manado:"SULAWESI UTARA",Palu:"SULAWESI TENGAH","Palu/Luwuk":"SULAWESI TENGAH",Makassar:"SULAWESI SELATAN","Pare Pare":"SULAWESI SELATAN",Palopo:"SULAWESI SELATAN",Bulukumba:"SULAWESI SELATAN",Kendari:"SULAWESI TENGGARA",Gorontalo:"GORONTALO",Ambon:"MALUKU",Ternate:"MALUKU UTARA",Timika:"PAPUA",Jayapura:"PAPUA",Marauke:"PAPUA",Sorong:"PAPUA BARAT",Manokwari:"PAPUA BARAT",Denpasar:"BALI",Mataram:"NUSATENGGARA BARAT",Bima:"NUSATENGGARA BARAT",Kupang:"NUSA TENGGARA TIMUR",Waikabubak:"NUSA TENGGARA TIMUR",Ruteng:"NUSA TENGGARA TIMUR",Ende:"NUSA TENGGARA TIMUR",Atambua:"NUSA TENGGARA TIMUR",Larantuka:"NUSA TENGGARA TIMUR"},z={"Region 1":"#ef4444","Region 2":"#3b82f6","Region 3":"#10b981","Region 4":"#f59e0b","Region 5":"#8b5cf6","Region 6":"#ec4899","Region 7":"#14b8a6","Region 8":"#f97316","Region 9":"#6366f1","Region 10":"#eab308"},N=p=>z[p]||"#94a3b8",X=J.memo(function({machines:s,engineers:u=[],onEngineerClick:k,isFullscreen:m=!1}){const[y,E]=A.useState(null),[q,Y]=A.useState(null),[I,h]=A.useState(!0),{theme:b,isDark:o}=F(),S=A.useMemo(()=>{const n={};return(u||[]).forEach(e=>{const t=e.area_group||"Unknown",r=e.region||"Unknown",i=P[t]||t;n[i]||(n[i]={areaGroup:i,cities:new Set,region:r,engineerCount:0,machineCount:0,engineers:[],latitude:0,longitude:0,validCoords:0}),n[i].cities.add(t),n[i].engineerCount++,n[i].engineers.push(e),e.latitude&&e.longitude&&(n[i].latitude+=parseFloat(e.latitude),n[i].longitude+=parseFloat(e.longitude),n[i].validCoords++)}),Object.keys(n).forEach(e=>{n[e].validCoords>0&&(n[e].latitude/=n[e].validCoords,n[e].longitude/=n[e].validCoords)}),(s||[]).forEach(e=>{const t=e.area_group||"Unknown",r=P[t]||t;n[r]||(n[r]={areaGroup:r,cities:new Set,region:"Unknown",engineerCount:0,machineCount:0,engineers:[],latitude:0,longitude:0,validCoords:0}),n[r].machineCount++}),n},[u,s]),T=A.useRef(null);if(A.useEffect(()=>(y&&Object.keys(S).length>0&&(T.current&&clearTimeout(T.current),T.current=setTimeout(()=>{const n=()=>{const e=j.latLngBounds();Object.values(S).forEach(t=>{t.latitude&&t.longitude&&t.validCoords>0&&e.extend([t.latitude,t.longitude])}),e.isValid()&&y.fitBounds(e,{padding:[50,50],animate:!1})};window.requestIdleCallback?window.requestIdleCallback(n,{timeout:500}):requestAnimationFrame(()=>{requestAnimationFrame(n)})},300)),()=>{T.current&&clearTimeout(T.current)}),[y,S]),(!u||u.length===0)&&(!s||s.length===0))return a.jsx("div",{className:"flex items-center justify-center h-full",children:a.jsx("div",{className:"text-slate-400",children:"No data available"})});const l=Object.values(S).filter(n=>n.validCoords>0||n.machineCount>0).sort((n,e)=>e.engineerCount+e.machineCount-(n.engineerCount+n.machineCount)),f=A.useMemo(()=>{const n={};return l.forEach(e=>{const t=e.region||"Unknown";n[t]||(n[t]={region:t,provinceCount:0,totalMachines:0,totalEngineers:0,provinces:[]}),n[t].provinceCount++,n[t].totalMachines+=e.machineCount,n[t].totalEngineers+=e.engineerCount,n[t].provinces.push({name:e.areaGroup,machines:e.machineCount,engineers:e.engineerCount})}),Object.keys(n).forEach(e=>{n[e].provinces.sort((t,r)=>r.machines-t.machines)}),n},[l]),B=A.useMemo(()=>l.sort((n,e)=>e.machineCount-n.machineCount).slice(0,5).map(n=>({name:n.areaGroup,machines:n.machineCount,engineers:n.engineerCount,region:n.region})),[l]),U=A.useMemo(()=>Math.max(...l.map(n=>n.engineerCount),1),[l]),L=A.useCallback(n=>{const e=n.properties.Propinsi||n.properties.name||"",t=l.find(c=>e.toUpperCase()===c.areaGroup.toUpperCase());let r,d=1.5,i=.4;if(t){r=N(t.region);const c=t.engineerCount/U;d=1.5+c*4.5,i=.4+c*.5}else r="#e5e7eb",d=1,i=.15;return{fillColor:r,fillOpacity:i,color:"#ffffff",weight:d,opacity:.95}},[l,U]),x=A.useCallback((n,e)=>{const t=n.properties.Propinsi||n.properties.name||"",r=l.find(d=>t.toUpperCase()===d.areaGroup.toUpperCase());if(r){const d=N(r.region),i=r.engineerCount/U,c=1.5+i*4.5,D=.4+i*.5,K=Array.from(r.cities||[]).join(", "),G=o?"#0f172a":"#ffffff",g=o?"#ffffff":"#0f172a",v=d,C=o?"rgba(0, 0, 0, 0.7)":"rgba(0, 0, 0, 0.2)";e.bindTooltip(`<div style="background: ${G}; padding: 12px 16px; border-radius: 8px; box-shadow: 0 8px 16px ${C}; border: 2px solid ${v}; line-height: 1.8; overflow: hidden;">
            <div style="font-weight: 700; font-size: 14px; margin-bottom: 8px; color: ${g};">📍 ${r.areaGroup}</div>
            <div style="color: ${g}; margin-bottom: 6px;">🏙️ ${K}</div>
            <div style="color: ${g}; margin-bottom: 6px;">🖥️ <span style="color: ${g}; font-weight: 700;">${r.machineCount||0}</span> mesin</div>
            <div style="color: ${g}; margin-bottom: 6px;">👷 <span style="color: ${g}; font-weight: 700;">${r.engineerCount}</span> engineers</div>
            <div style="color: ${g}; font-size: 12px; opacity: 0.9;">🗺️ ${r.region}</div>
          </div>`,{sticky:!0,className:"custom-map-tooltip",direction:"auto",permanent:!1});let R=null;e.on({mouseover:M=>{R&&clearTimeout(R),R=setTimeout(()=>{requestAnimationFrame(()=>{M.target.setStyle({fillOpacity:.95,weight:c+2})})},16)},mouseout:M=>{R&&clearTimeout(R),requestAnimationFrame(()=>{M.target.setStyle({fillOpacity:D,weight:c})})}})}},[l,U,o]);return a.jsxs("div",{className:"map-container relative",style:{height:"100%",width:"100%",borderRadius:m?"0":"16px",overflow:"hidden",boxShadow:m?"none":"0 20px 25px -5px rgba(0, 0, 0, 0.3)",border:m?"none":"1px solid rgba(59, 130, 246, 0.2)"},children:[a.jsxs(W,{center:[-2.5489,118.0149],zoom:5,style:{height:"100%",width:"100%"},whenCreated:E,zoomControl:!0,children:[a.jsx(w,{url:"https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png",attribution:'© <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>'}),a.jsx(O,{data:H,style:L,onEachFeature:x},`geojson-${b}`)]}),I?a.jsxs("div",{className:`absolute top-4 right-4 z-[100] ${o?"bg-slate-900/95":"bg-white/95"} backdrop-blur-sm rounded-lg border ${o?"border-slate-700":"border-gray-300"} shadow-xl p-4 max-w-xs`,children:[a.jsxs("div",{className:"flex items-center justify-between mb-3",children:[a.jsx("h3",{className:`font-bold text-sm ${o?"text-white":"text-gray-900"}`,children:"🗺️ Legend"}),a.jsx("button",{onClick:()=>h(!1),className:`p-1 rounded hover:${o?"bg-slate-800":"bg-gray-100"} transition-colors ${o?"text-slate-400 hover:text-white":"text-gray-500 hover:text-gray-700"}`,title:"Sembunyikan Legend",children:a.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:a.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})})})]}),a.jsxs("div",{className:"mb-4",children:[a.jsx("p",{className:`text-xs font-semibold mb-2 ${o?"text-slate-300":"text-gray-700"}`,children:"Region"}),a.jsx("div",{className:"space-y-1.5",children:["Region 1","Region 2","Region 3"].map(n=>{const e=N(n),t=f[n];return a.jsxs("div",{className:"flex items-center gap-2 text-xs",children:[a.jsx("div",{className:"w-4 h-4 rounded border-2 border-white shadow-sm",style:{backgroundColor:e}}),a.jsx("span",{className:`flex-1 ${o?"text-slate-200":"text-gray-800"}`,children:n}),t&&a.jsxs("span",{className:`font-semibold ${o?"text-slate-400":"text-gray-600"}`,children:[t.provinceCount," prov"]})]},n)})})]}),B.length>0&&a.jsxs("div",{children:[a.jsx("p",{className:`text-xs font-semibold mb-2 ${o?"text-slate-300":"text-gray-700"}`,children:"🏆 Top 5 Provinsi (Mesin)"}),a.jsx("div",{className:"space-y-1.5 max-h-48 overflow-y-auto",children:B.map((n,e)=>{const t=N(n.region);return a.jsxs("div",{className:`flex items-center gap-2 text-xs p-1.5 rounded ${o?"bg-slate-800/50":"bg-gray-50"} hover:${o?"bg-slate-800":"bg-gray-100"} transition-colors`,children:[a.jsx("span",{className:`font-bold w-5 text-center ${o?"text-slate-400":"text-gray-500"}`,children:e+1}),a.jsx("div",{className:"w-3 h-3 rounded border border-white/50",style:{backgroundColor:t}}),a.jsxs("div",{className:"flex-1 min-w-0",children:[a.jsx("div",{className:`font-medium truncate ${o?"text-slate-200":"text-gray-800"}`,children:n.name}),a.jsxs("div",{className:`text-xs ${o?"text-slate-400":"text-gray-600"}`,children:[n.machines," mesin"]})]})]},e)})})]})]}):a.jsx("button",{onClick:()=>h(!0),className:`absolute top-4 right-4 z-[100] ${o?"bg-slate-900/95 hover:bg-slate-800":"bg-white/95 hover:bg-gray-50"} backdrop-blur-sm rounded-lg border ${o?"border-slate-700":"border-gray-300"} shadow-xl p-2 transition-colors`,title:"Tampilkan Legend",children:a.jsx("svg",{className:`w-5 h-5 ${o?"text-slate-300":"text-gray-700"}`,fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:a.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 6h16M4 12h16M4 18h16"})})})]})},(p,s)=>{var u,k,m,y;return!(p.isFullscreen!==s.isFullscreen||p.onEngineerClick!==s.onEngineerClick||p.machines!==s.machines&&((u=p.machines)==null?void 0:u.length)!==((k=s.machines)==null?void 0:k.length)||p.engineers!==s.engineers&&((m=p.engineers)==null?void 0:m.length)!==((y=s.engineers)==null?void 0:y.length))});export{X as default};
